...
1.  **Distributed Sampling**: The 240,480 samples are partitioned by a `DistributedSampler`. Each GPU only sees its 1/4th of the data per epoch, ensuring the model generalizes across the whole set.
